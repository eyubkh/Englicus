...
const GreenButtonComponent = styled(Button)`
...
export const GreenButton = ({ handler, children }) => {
  return <GreenButtonComponent onClick={handler}>{children}</GreenButtonComponent>
}
